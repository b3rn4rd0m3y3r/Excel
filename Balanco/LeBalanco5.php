...
<table border=1 cellspacing=0 cellpadding=4>
	<tr>
		...
		// NOVO - Total direto do array (Conta redundante)
		echo "<b>TOTAL ......................... " . $oarrSumsCtas["Ativo"]["Ativo"]["VALOR_f_2"] . "</b><br>";
		?>
		</td>
		<td>
			<table border=0 cellspacing=0 cellpadding=4>
				...
				<h1>PASSIVO</h1>
				<?php
				foreach( $oarrSumsCtas["Passivo"] as $keyc=>$valorc ){
					foreach( $valorc as $keyd=>$valord ){
						if( $keyc != "Passivo" ){
							echo $keyc . " ... " . $valord . "<br>";
							}
				...
				// NOVO - Total direto do array (Conta redundante)
				echo "<b>TOTAL ......................... " . $oarrSumsCtas["Passivo"]["Passivo"]["VALOR_f_2"] . "</b><br>";
				?>				
				</td>
				</tr>
				<tr><td>
				...
				<?php
				foreach( $oarrSumsCtas["PL"] as $keyc=>$valorc ){
					foreach( $valorc as $keyd=>$valord ){
						if( $keyc != "PL" ){
							echo $keyc . " ... " . $valord . "<br>";
							}
				...
				// NOVO - Total direto do array (Conta redundante)
				echo "<b>TOTAL ......................... " . $oarrSumsCtas["PL"]["PL"]["VALOR_f_2"] . "</b><br>";
				?>				
				</td></tr>
			</table>
		</td>
